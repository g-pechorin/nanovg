###	Peter LaValle
###	pal_glfw-3.1.2.cmake
###		Voodoo to rope GLFW into your build
###
### 2016-03-13
###		(previously) removed the STB files since I was getting them from elsewhere
### 
### 2016-02-24
###		Updated to GLFW 3.1.2
###
###	2015-05-24
...
## PAL_CMAKE
#
# 2016-03-14 ; added a line to prevent use of the vcrt.DLL
# 2015-07-31 ;
...
# this prevents DLL hell
# ... and basically costs us nothing
set(BUILD_SHARED_LIBS OFF CACHE BOOL "Don't use shared libs - ever" FORCE)

# this prevents cryptic errors that only ever happen on user machines
# ... and makes the .exe a teeny bit bigger (< 1MB IIRC)  
...
##
# Add the GLFW stuff
	scrape_archive(glfw e16780a9a7fda3c289dc097d6d2c0efa https://github.com/glfw/glfw/archive/3.1.2.zip)

	add_subdirectory(${PAL_DUMP_CACHE}/pal-rat/glfw/glfw-3.1.2 glfw)
	include_directories(${PAL_DUMP_CACHE}/pal-rat/glfw/glfw-3.1.2/include)
